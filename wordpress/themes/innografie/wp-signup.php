...
/* eww - wp-signup.php now in theme directory */
...
function validate_blog_signup() {
	...
	/* eww */
	if (empty($_POST['cimy_uef_COMPANY'])) {
		$errors->errors['cimy_uef_1'] = array('Bitte geben Sie den Namen Ihres Unternehmens ein.');
	}
	/* ~eww */
